...
define("MESSAGE_PASSWORD_RESET_MAIL_SUCCESSFULLY_SENT", "Password reset mail has successfully been sent! You may need to check your spam folder.");
...
define("MESSAGE_VERIFICATION_MAIL_SENT", "Your account has been created successfully and we have sent you an email. Please click the VERIFICATION LINK within that mail. You may need to check your spam folder.");
...
define("WORDING_EDIT_YOUR_CREDENTIALS", "you can edit your info here");
...
define("WORDING_NEW_USERNAME", "New username (must be alphanumeric and 2-64 characters)");
...
define("WORDING_REGISTRATION_EMAIL", "User's email");
...
define("WORDING_REGISTRATION_USERNAME", "Username (alphanumeric, 2 to 64 characters)");
define("WORDING_REMEMBER_ME", "Keep me logged in (for 2 weeks)");
define("WORDING_REQUEST_PASSWORD_RESET", "Enter username to reset password:");
define("WORDING_RESET_PASSWORD", "Reset");
