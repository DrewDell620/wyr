...
define("COOKIE_DOMAIN", ".domain.name.com");
 ...
 * define("EMAIL_SMTP_USERNAME", "example@gmail.com");
 ...
 */
define("EMAIL_USE_SMTP", true);
define("EMAIL_SMTP_HOST", "ssl://ssrs.smtphost.net");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "username\admin");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://wyr.cu.cc/templates/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@wyr.cu.cc");
define("EMAIL_PASSWORDRESET_FROM_NAME", "WYR.cu.cc");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for WYR.cu.cc");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://wyr.cu.cc/templates/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@wyr.cu.cc");
define("EMAIL_VERIFICATION_FROM_NAME", "WYR.cu.cc");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for WYR.cu.cc");
