...
class Login
{
    ...
    /**
     * @var string $user_gravatar_image_url The user's gravatar profile pic(small) url (or a default one)
     */
    public $user_gravatar_image_url = "";
    /**
     * @var string $user_gravatar_image_url2 The user's gravatar profile pic(large) url (or a default one)
     */
    public $user_gravatar_image_url2 = "";
    /**
     * @var string $user_gravatar_image_tag The user's gravatar profile pic(small) url with <img ... /> around
     */
    public $user_gravatar_image_tag = "";
    /**
     * @var string $user_gravatar_image_tag2 The user's gravatar profile pic(large) url with <img ... /> around
     */
    public $user_gravatar_image_tag2 = "";
    /**
    ...
    public function __construct()
    {
        ...
        if ($this->isUserLoggedIn() == true) {
            $this->getGravatarImageUrl2($this->user_email);
        }
    }
    ...
    public function getGravatarImageUrl2($email, $s = 250, $d = 'mm', $r = 'g', $atts = array() )
    {
        ...
        // http://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50?s=80&d=mm&r=g
        // note: the url does NOT have something like .jpg
        $this->user_gravatar_image_url2 = $url2;
        ...
        // the image url like above but with an additional <img src .. /> around
        $this->user_gravatar_image_tag2 = $url2;
    }
